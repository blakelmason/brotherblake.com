  ...
  return (
    ...
    >
      <p>
        ...
        book of Isaiah. One of the challenges we face for studying Isaiah is the
        format of our scriptures. By forcing these writings into the typical
        chapter and verse structure, we lose some of the way Isaiah's ideas are
        meant to be organized in our mind. Isaiah 1 being more of an
      ...
      Isaiah prophesied during the reign of these 4 kings in Judah. See the
      chart below for reference.
      <Image2 src="https://i.imgur.com/rlMWhO0.png" pb />
      <p>
        Isaiah prophesied to a wicked generation, and unfortunately during his
        life he witnessed incredible destruction that was brought to pass by
        this wickedness. Much of his prophecies are full of warnings of
        destruction to the people, and desperate cries for repentance so that
        the destruction would be witheld. We immediately hear this voice of
        admonition in the next verses.
      </p>
      <Box>
        <Verse number="2">
      ...
      <p>
        Isaiah is alluding to the threat of Assyria in verse 7. During his
        lifetime, Assyria was the major superpower and the threat of destruction
        by them was very real. If we go back to the chart of kings, we see that
        during Isaiah's lifetime the kingdom of Israel was destroyed by Assyria.
        Judah was almost destroyed as well, but was miraculously saved right
        before Assyria's victory over Jerusalem. The siege of Jerusalem by
        Assyria is found later in the book of Isaiah, beginning in Isaiah 36.
        See <Link to="/topics/A/Assyria">Assyria</Link>.
      </p>
      <Box>
        <Verse number="8" last>
      ...
      <p>
        The "cottage" and "lodge" are both structures which are only used to
        temporarily store produce during harvest time. Otherwise, they are a
        desolate, rundown shack that no one visits. Isaiah is using symbolism to
        describe how the Lord has forsaken them because of their wickedness,
        just like how workers leave these huts after the harvest is over.
      </p>
      <Box>
        <Verse number="9" last>
      ...
      <p>
        Verses 9 - 15 are about how the covenant people of the Lord think they
        are righteous, but they have{' '}
        <Link2 href="https://idioms.thefreedictionary.com/have+blood+on+your+hands">
        ...
        what the people need to do to be healed and become whole.
      </p>
      <Box>
        <Verse number="16">
        ...
        <Verse number="19" last>
          If ye be willing and obedient, ye shall eat the good of the land:
        </Verse>
      </Box>
      The rest of the chapter is more warnings and proclamations of the people's
      corruption.
      <Box>
        <Verse number="21">
        ...
        <Verse number="22">
          Thy silver is become <span className="definition">dross,</span>{' '}
          <D>something regarded as worthless; rubbish.</D> thy wine mixed with
          water:
        </Verse>
        <Verse number="23">
        ...
        <Verse number="24">
          ...
          Ah, I will <span className="translation">relieve</span> <T>ease</T> me
      ...
      <p>
        Verse 29 is about the idol worship in Judah and Israel. The "oaks" and
        "gardens" are symbols of the people worshipping false gods. The worship
        of false gods generally entailed extremely terrible actions by the
        people. See{' '}
        <Link2 href="http://www.churchofjesuschrist.org/study/scriptures/bofm/alma/14?lang=eng">
          {' '}
          Alma 14
        </Link2>{' '}
        for an example.
      ...
      Tow is flax or hemp fibers prepared for spinning. It is very flammable.
      See the image below.
      <Image2 src="https://i.imgur.com/zb2WEIA.jpg" />
    </Template>
  )
}
